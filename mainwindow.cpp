...
void MainWindow::displayOscilloscopeChannelData(int dislayFrom, int displayedLength, int removeFrom)
{
...
void MainWindow::processOscilloscopeData(SamplesList leftChannelData, SamplesList rightChannelData)
{
